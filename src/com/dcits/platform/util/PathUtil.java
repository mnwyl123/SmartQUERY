...
public class PathUtil {
	...
	public static String getClasspath(){
		...
		String path = serverInfo.getString("share_path");
		return path;
	}
	public static String getClasspathurl(){
		...
		String path = serverInfo.getString("url_path");
		return path;
	}
	public static String getsleeptime(){
		...
		String path = serverInfo.getString("sleeptime");
		return path;
	}
	public static String getClasspathurlhist(){
		PageData serverInfo=new PageData();
		try {
			serverInfo = BaseController.getServerInfo();
		} catch (IOException e) {
		...
		String path = serverInfo.getString("url_pathhist");
		return path;
	}
	/*
	 * 获取classpath2
