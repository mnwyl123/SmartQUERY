...
public class PWDDes {
    ...
    public static void main(String[] args) {
        PWDDes ttt = new PWDDes();
        String key1 = "FIN";//密钥1
        String key2 = "3306";//密钥2
        String key3 = "smartsense";//密钥3
        String data = "FIN";//要加密的字符串
        String str = ttt.strEnc(data, key1, key2, key3);//加密
        logger.debug(str);
        String dec = ttt.strDec(str, key1, key2, key3);//解密
        logger.debug(dec);
    }
    ...
    public String strEnc(String data, String firstKey, String secondKey,
        ...
        if (leng > 0) {
            if (leng < 4) {
                ...
                encData.delete(0, encData.length());
