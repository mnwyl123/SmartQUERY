package com.dcits.platform.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("UserUpLine")){
			this.userjoin(message.replaceFirst("UserUpLine", ""),conn);
		}if(null != message && message.startsWith("LeaveUserDownLine")){
			this.userLeave(conn);
