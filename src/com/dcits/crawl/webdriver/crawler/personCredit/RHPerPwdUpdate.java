...
import com.dcits.crawl.util.ExecuteSQL;
import com.dcits.crawl.util.PasswordOper;
import com.dcits.crawl.webdriver.crawler.WaitTime;
import com.dcits.crawl.webdriver.crawler.WebDriverInfo;
...
//        System.out.println(decode);
        /*String xxx = PasswordOper.encode("x12345678");
		...
		public void updatePWD(){
			...
			try {
				while(result.next()){
					...
					System.out.println(PasswordOper.encode(new_password));
					System.out.println("==================================");
