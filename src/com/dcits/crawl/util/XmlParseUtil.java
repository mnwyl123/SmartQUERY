...
public class XmlParseUtil{
	...
	public static Map<String,String> allCol = TableInfoUtil.xmlToCol();
	public static Map<String,String> allTab = TableInfoUtil.xmlToTab();
...
//		System.out.println(xml);
		...
		if(errXmlTag.size()>0){
			System.out.println(errXmlTag.toString());
		}else{
			System.out.println(JSONObject.fromObject(toPd));
		}
		System.out.println("用时"+(System.currentTimeMillis()-sdate)+"毫秒");
	}
...
//		report_id = new BigDecimal(report_id).add(new BigDecimal(new Date().getTime()+"")).toString();
		...
		if("1".equals(authType)){
			...
			List<Map<String, String>> per_basic =  (List<Map<String, String>>) toPd.get("PER_BASIC");
