...
public class setQueryKey {
	...
	//触发查询事件
	public void ClickQuery(WebDriver dr,PageData pd,PersonCrawlerManager personCrawlerService,IndAppReManager indAppReService,String beforeUrl){
		//用户姓名
