...
import com.dcits.credit.service.queryStatistics.UserQueryVolumeManager;
 ...
 * @version
 */
@Service("UserQueryVolumeService")
public class UserQueryVolumeService implements UserQueryVolumeManager{
	...
	public void save(PageData pd)throws Exception{
		dao.save("UserQueryVolumeMapper.save", pd);
	}
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("UserQueryVolumeMapper.delete", pd);
	}
	...
	public void edit(PageData pd)throws Exception{
		dao.update("UserQueryVolumeMapper.edit", pd);
	}
	...
	public List<PageData> list(Page page)throws Exception{
		...
		if("0".equals(flag)){//当前用户为内部授权人角色用户
			return (List<PageData>)dao.findForList("UserQueryVolumeMapper.dataCheckUserlistPage", page);
		}else if("2".equals(flag)){ //查询员
			return (List<PageData>)dao.findForList("UserQueryVolumeMapper.dataQueryUserlistPage", page);
		}else{
			return (List<PageData>)dao.findForList("UserQueryVolumeMapper.datalistPage", page);
		}
		//return (List<PageData>)dao.findForList("UserQueryVolumeMapper.datalistPage", page);
	}
	...
	public List<PageData> detailList(Page page)throws Exception{
		List<PageData>varList = (List<PageData>)dao.findForList("UserQueryVolumeMapper.detaillistPage", page);
	...
	public List<PageData> detailListHis(Page page)throws Exception{
		List<PageData>varList = (List<PageData>)dao.findForList("UserQueryVolumeMapper.hisDetaillistPage", page);
		int size = varList.size();
		for(int i=0;i<size;i++) {
			String CLIENT_NAME = varList.get(i).getString("CLIENT_NAME");
			String CREDENTIALS_NO = varList.get(i).getString("CREDENTIALS_NO");
	...
	public PageData findById(PageData pd)throws Exception{
		return (PageData)dao.findForObject("UserQueryVolumeMapper.findById", pd);
	}
	...
	public void deleteAll(String[] ArrayDATA_IDS)throws Exception{
		dao.delete("UserQueryVolumeMapper.deleteAll", ArrayDATA_IDS);
	}
