...
public class test1 {
	...
	public static void main(String[] args) throws SQLException, MalformedURLException, InterruptedException {
        String id = "a43caedd553f4e5fb849d475160d760acf417f8a15f349cd8a22ebc93a5eba43";
		Long query_no54 = (long) 200022;//流水号需要更改	
		Long query_no54i = (long) 293370;//流水号需要更改
		//个人申请接口
		URL interXML = new URL("http://10.9.0.207:8080/SmartSense/rest/personInterface/queryRequestInterface");
		URL url54p = new URL("http://10.16.0.21:8080/SmartSense/rest/personInterface/queryRequest");
		URL url54pf = new URL("http://10.9.0.207:8080/SmartSense/rest/personInterface/queryRequestFast");	
...
// 		}
 		...
 		for(int i=0;i<1;i++){
 			...
 			query_no54i++;
 			na++;
 			//String name54 = "张某某  11010819931010444X";
 			String name54 = "赵韦韦";
 			String name54i = "王66568小二"+i;
 			String  paramXml =  "{\"ID\":\""+id+"\"}";
 	         		
 			String  param54 =  "{\"USERNAME\":\"zj-hongfei\","
 	         		+ "\"CLIENT_NAME\":\""+name54+"\",\"CREDENTIALS_TYPE\":\"10\",\"CREDENTIALS_NO\":\"612727199012172411\","
