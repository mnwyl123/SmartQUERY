					...
					<div class="row">
						<div class="">
								<form action="Channel/saveChannel.do" name="Form" id="Form" method="post">
									...
									<input type="hidden" name="CHANNEL_ID" id="CHANNEL_ID" value="${pd.CHANNEL_ID }" readonly/>
									<div id="zhongxin" class="paddingt-13">
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										<tr>
											<td class="align-right">渠道编号:<span class="red ">*</span></td>
											<td><input type="text" name="CHANNEL_ID1" id="CHANNEL_ID1" value="${pd.CHANNEL_ID}" maxlength="20" readonly class="width-75"/></td>
										</tr>
										<tr>
