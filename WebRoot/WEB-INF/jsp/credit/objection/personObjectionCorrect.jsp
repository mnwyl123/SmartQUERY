...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="personObjection/listCorrect.do?menuId=95" method="post" name="Form" id="Form">
						<table class="" id="tab">
							<tr>
								<td align="right">
									    发起用户名称:
								...
								<td>
										<select  name="CORRECTRESULT" id="CORRECTRESULT" style="width: 163px;"> 
											<option value="">--</option>
	...
	<script type="text/javascript">
		...
		function writeResult(ID,OBJCHECKID,OBJCHECKNUM){
			 ...
			 diag.Drag=true;
			 diag.Title ="处理结果填写";
			 diag.URL = '<%=basePath%>personObjection/goCheckResultReport.do?ID='+ID+'&OBJCHECKID='+OBJCHECKID+'&OBJCHECKNUM='+OBJCHECKNUM+'&TYPE=2';
			 diag.Width = 600;
			 diag.Height = 400;
