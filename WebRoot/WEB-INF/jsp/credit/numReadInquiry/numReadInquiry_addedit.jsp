					...
					enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped "><!-- table-bordered table-hover -->
							...
							<tr>
								...
								<td><input type="text" class="span10 date-picker width-75" data-date-format="yyyy-mm-dd" name="PRODUCE_DATE" id="PRODUCE_DATE" value="" maxlength="1" placeholder="这里输入是产品时间" title="产品时间"  readonly/></td>
							</tr>
							<tr>
