		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="CreditInquiry/${msg}.do?INTERNAL=1" name="Form" id="Form" method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped "><!-- table-bordered table-hover -->
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control width-75" disabled dict-name="CRED_TYPE" default-value="${pd.CREDENTIALS_TYPE}" name="CREDENTIALS_TYPE" id="CREDENTIALS_TYPE">
									</select>
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control width-75" dict-name="FIND_REASON" default-value="${pd.FIND_REASON}" name="QUERY_REASON" id="FIND_REASON">
									</select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control width-75" disabled dict-name="FIND_TYPE" default-value="${pd.QUERY_TYPE}" name="QUERY_TYPE" id="FIND_TYPE">
									</select>
							...
							<tr>
							    <td class="align-right width-25">身份证明文件上传:</td>
								<td class="z_photo upimg-div clear">
									<section class="z_file fl">
									    <c:if test="${pd == null || pd.IDENTITY_DOCUMENT == '' || pd.IDENTITY_DOCUMENT == null }">
										 ...
										 <c:if test="${pd != null && pd.IDENTITY_DOCUMENT != '' && pd.IDENTITY_DOCUMENT != null }">
										 <img src="<%=basePath%>uploadFiles/uploadImgs/${pd.IDENTITY_DOCUMENT}" width="210"/>
										 </c:if>
								...
								<td>
									<select class="chosen-select form-control width-75" name="CHECK_SYS_ID" id="CHECK_SYS_ID">
										<c:forEach items="${checkUserList}" var="checkUser">
											<!--<option value="${checkUser.USER_ID }" <c:if test="${pd.CHECK_SYS_ID == checkUser.USER_ID}">selected</c:if>> ${checkUser.NAME}</option>-->
