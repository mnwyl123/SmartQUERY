		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="queryWarn/crossRegionlist.do?menuId=55" name="Form" id="Form" method="post">
						<div style="">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="center">被查询人姓名/单位名称</th>
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty crossRegionlist}">
									<c:forEach items="${crossRegionlist}" var="dsl" varStatus="vs">											
										<tr>
											<td class='center' style="width: 100px;">${vs.index+1}</td>
											<td class="center">${dsl.USERNAME}</td>
											<td class="center">${dsl.USERREALNAME}</td>
											<td class="center">${dsl.REGIONALISMCODE}</td>
											<td class="center">${dsl.CLIENTNAME}</td>
											<td class="center">${dsl.CHINACREDITCODE}</td>
											<td class="center">${dsl.DATADATE}</td>
										</tr>
