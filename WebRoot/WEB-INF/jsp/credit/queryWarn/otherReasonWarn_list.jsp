		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="queryWarn/otherReasonlist.do?menuId=56" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="width:100%;table-layout:fixed">
							<thead>
								<tr>
									...
									<th class="center">选择其他理由查询笔数</th>
									<th class="center">选择其他理由查询占比</th>
								</tr>
							</thead>					
							<tbody>
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty otherReasonlist}">
									<c:forEach items="${otherReasonlist}" var="dsl" varStatus="vs">											
										<tr>
											...
											<td class="center">${dsl.OTHERREASONCNT}</td>
											<td class="center">${dsl.OTHERREASONPERCENT}</td>
										</tr>
