		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="queryWarn/noWorkTimelist.do?menuId=54" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="width:100%;table-layout:fixed">
							<thead>
								<tr>
									...
									<th class="center" style="width:80px">客户类型</th>
									<th class="center">客户名称</th>
									<th class="center">证件标识</th>
									<th class="center" style="width:80px">查询结果</th>
								</tr>
							</thead>					
							<tbody>
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty noWorkTimelist}">
									<c:forEach items="${noWorkTimelist}" var="dsl" varStatus="vs">											
										<tr>
											<td class='center'>${vs.index+1}</td>
											<td class="center">${dsl.USERNAME }</td>
											<td class="center">${dsl.USERREALNAME}</td>
											<td class="center">${dsl.ORGNAME}</td>
											<td class="center">${dsl.QUERYTIME}</td>
											<td class="center">${dsl.CLIENTTYPE}</td>
											<td class="center">${dsl.CLIENTNAME}</td>
											<td class="center">${dsl.CERTNO}</td>
											<td class="center">${dsl.QUERYRESULT}</td>
										</tr>
