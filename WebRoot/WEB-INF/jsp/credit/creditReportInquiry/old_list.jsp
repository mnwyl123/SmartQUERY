			            ...
			            <table class="margin-5 width-100">
							<tr>
								...
								<td class="align-right width-30">
									 <div class="btn-group" >
										<a class="btn btn-orange btn-mini" onclick="add();" title="转存"><i class="iconfont icon-tianjia"></i></a>
									</div>
									<div class="btn-group" >
										<a class="btn btn-orange btn-mini" onclick="cip();" title="cip数据处理"><i class="iconfont icon-tianjia"></i></a>
									</div>
								</td>
							</tr>
