			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="PersonReportInquiry/list.do?menuId=38" method="post" name="Form" id="Form">
					...
					$.ajax({
						...
						success: function(data){
							 if("success" != data.result){
								 $(top.hangge());
								 //alert(/mast../+data.filePath);
								//window.location.href='http://localhost:7001/SmartSense/uploadFiles/uploadImgs/20170821300300000003.html';
								window.location.href=data.filePath;
								return false;
								//window.navigate(data.filePath);
								//$("#links").load("D:\yilian\ID.html");
							 }
						}
				   });
//				}else{
...
//					diag.Drag=true;
//					diag.Title ="查询申请";
//					diag.URL = '<%=basePath%>CreditInquiry/goEdit.do?ID='+ID;
//					diag.Width = 510;
//					diag.Height = 640;
