		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="">
								<form action="qeurySet/UpdateQ.do" name="Form" id="Form" method="post">
									<input type="hidden" name="USER_ID" id="USER_ID" value="${pd.USER_ID }" readonly/>
									<input type="hidden" name="type" id="type" value="${pd.USER_TYPE }" readonly/>
									...
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										<tr>
											...
											<td><input type="text" name="USERNAME" id="USERNAME" readonly value="${pd.USERNAME}" maxlength="32" class="width-75" /></td>
										</tr>
										<tr>
											<td class="align-right">用户类型:</td>
											<td>
												<select style="width:258px" dict-name="clientType" disabled default-value="${pd.USER_TYPE}" name="USER_TYPE" id="USER_TYPE"/>
												</select>
											</td>
										</tr>
										<tr>
											<td class="align-right">查询上限值:</td>
											<td><input type="NUMBER" name="QUERY_MIN_COUNT" id="QUERY_MIN_COUNT" value="${pd.QUERY_MIN_COUNT}" maxlength="32" class="width-75"/></td>
										</tr>
										<tr>
											<td class="align-right">查询预警倍数:</td>
											<td><input type="NUMBER" name="QUERY_MULTIPLE" id="QUERY_MULTIPLE" value="${pd.QUERY_MULTIPLE}" maxlength="32" class="width-75"/></td>
										</tr>
										<%-- <tr>
