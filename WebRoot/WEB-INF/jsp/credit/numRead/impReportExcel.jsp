		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="createReport/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								<table style="width:95%;" >
									...
									<!-- <tr>
										<td class="center" style="padding-top: 200px;"><span class="red ">证件号码唯一，重复信息不会上传！！！</span></td>
									</tr> -->
								</table>
								</div>
								<div style="bottom: 190px;position: fixed;margin-left:260px;">
								    <a onclick="window.location.href='<%=basePath%>/createReport/downExcel.do'" onmouseover="pic1(this);" onmouseout="pic2(this);"><i id ="changePic" class="iconfont icon-moban bigger-190 green1" style="width:35px;height:35px;"></i><span style="font-size:12px;position: relative;top:20px;left:-40px;color: #595959;">数据模板</span> </a>
								</div>
	...
	<script type="text/javascript">
			...
			$("#Form").ajaxForm({
				success:function(data){
					...
					if(data.msg=="success"){
						...
						top.Dialog.close();
					}else if(data.msg=="Eerror"){
						bootbox.dialog({
							message: "<span class='bigger-110'>导入异常</span>",
							buttons: 			
							{ 
								"button":
									{ 
						...
						bootbox.dialog({
							message: "<span class='bigger-110'>"+data.errCertno+"等身份证号不正确</span>",
							buttons: 			
							{ 
								"button":
									{ 
		...
		function fileType(obj){
		    ...
		    if(fileType != '.xls'||fileType != '.xlsx'){
		    	...
		    	$("#excel").val('');
		    	document.getElementById("excel").files[0] = '请选择xls格式或xlsx的文件';
		    }
		}
	</script>
