		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="SavePersonInquiryController/save.do" name="Form" id="Form" method="post" 
							...
							<tr>
								...
								<td class="z_photo upimg-div clear">
									<section class="z_file fl">
										...
										<input type="file" name="IDENTITY_DOCUMENT" id="IDENTITY_DOCUMENT" value="${pd.IDENTITY_DOCUMENT}"  class="file" accept="image/jpg,image/jpeg,image/png,image/bmp,image/JPG,image/JPEG,image/PNG,image/BMP"/>
									 </section>
								</td>
								<aside class="mask works-mask">
									<div class="mask-content">
