...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="entObjectRemark/listObjTransRecord.do?menuId=94" method="post" name="Form" id="Form">
						<table class="margin-5 width-100">
							<tr>
								<td class="align-left width-95">
									<div class="float-l margin2-4">	
									    <span>发起用户名称:<span>
										<input style="width:80px" id="NAME" type="text" value="${pd.NAME}" name="NAME" placeholder="用户姓名" />
									</div>
									<div class="float-l margin2-4">	
										<span>异议事项号:<span>
	...
	<script type="text/javascript">
		...
		function writeResult(ID,OBJCHECKID,OBJCHECKNUM,PHONENUM,CHECKRESULT,CHECKRESULTDESC){
			// var desc = Base64.encode(CHECKRESULTDESC);
			 //var param = {PHONENUM:PHONENUM,CHECKRESULT:CHECKRESULT,CHECKRESULTDESC:desc,ID:ID,OBJCHECKID:OBJCHECKID,OBJCHECKNUM:OBJCHECKNUM};
			 //var param = "{PHONENUM:"+PHONENUM+",CHECKRESULT:"+CHECKRESULT+",CHECKRESULTDESC:"+Base64.encode(CHECKRESULTDESC)
			//	+",ID:"+ID+",OBJCHECKID:"+OBJCHECKID+",OBJCHECKNUM:"+OBJCHECKNUM+",TYPE:1}";
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="处理结果填写";
			 diag.URL = '<%=basePath%>entObjectRemark/goCheckResultReport.do?ID='+ID+'&OBJCHECKID='+OBJCHECKID+'&OBJCHECKNUM='+OBJCHECKNUM+'&TYPE=1'+'&PHONENUM'+PHONENUM+'&CHECKRESULT'+CHECKRESULT+'&CHECKRESULTDESC'+CHECKRESULTDESC;
			 diag.Width = 600;
			 diag.Height = 400;
