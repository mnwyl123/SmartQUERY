...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="entObjectRemark/listObjTransRecCor.do?menuId=96" method="post" name="Form" id="Form">
						<table class="margin-5 width-100">
							<tr>
								<td class="align-left width-95">
									...
									<div class="float-l margin2-4">	
									    <span>是否接受更正结果:<span>
										<select  name="CORRECTACCEPTFLAG" id="CORRECTACCEPTFLAG" style="width: 120px;"> 
											<option value="">--</option>
	...
	<script type="text/javascript">
		...
		function writeResult(ID,OBJCHECKID){
			...
			top.jzts();
			$.ajax({
				url:'<%=basePath%>entObjectRemark/correctAcceptReport.do',
