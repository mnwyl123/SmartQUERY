						...
						<div class="">
								<form action="IndAppRe/saveAppCheck.do" name="Form" id="Form" method="post">
									...
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										...
										<!-- <tr>
										<td class="align-right width-35">申请产品:</td>
										<td>
											<select style="width:260px"class="width-75" disabled name="PRO_ID" id="PRO_ID">
												<c:forEach items="${prolist}" var="pro">
													<option value="${pro.PRODUCT_ID}"<c:if test="${appInfo.PRO_ID==pro.PRODUCT_ID}">selected</c:if>>
														${pro.PRODUCT_NAME}
													</option>
												</c:forEach>
											</select>
										...
										<tr>
											...
											<td>
												<select style="width:260px" disabled dict-name="CRED_TYPE_PER" default-value="${appInfo.CREDENTIALS_TYPE}" name="CREDENTIALS_TYPE" id="CREDENTIALS_TYPE" class="width-75">
											</select>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<select style="width:260px" disabled dict-name="find_reason_per" default-value="${appInfo.QUERY_REASON}" name="QUERY_REASON" id="QUERY_REASON" class="width-75">
											</select>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												...
												<c:if test="${appInfo.WARRANTTYPE == 'pdf'}">
													<input readonly value="${appInfo.WARRANT}" />
												</c:if>
												</a>
											</td>
										</tr>
										<%-- <c:if test="${appInfo.LOAN_APPLICATION != '0' }">
											<tr>
												...
												<td>
													<a href="${appInfo.LOAN_APPLICATION}" target="_blank"><img src="${appInfo.LOAN_APPLICATION}" width="210"/></a>
												</td>
											</tr>
										</c:if> --%>
							 			<tr>
											...
											<td>
												<a href="${appInfo.LOAN_APPLICATION}" target="_blank">
													...
													<c:if test="${appInfo.LOAN_APPLICATIONTYPE == 'pdf'}">
														<input readonly value="${appInfo.LOAN_APPLICATION}" />
													</c:if>
												</a>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<a href="${appInfo.IDENTITY_DOCUMENT}" target="_blank">
													...
													<c:if test="${appInfo.IDENTITY_DOCUMENTTYPE == 'pdf'}">
														<input readonly value="${appInfo.IDENTITY_DOCUMENT}" />
													</c:if>
												</a>
											</td>
										</tr>
