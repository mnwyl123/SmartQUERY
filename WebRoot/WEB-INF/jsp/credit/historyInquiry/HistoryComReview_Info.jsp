								...
								<form action="" name="Form" id="Form" method="post">
									...
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										...
										<tr>
											...
											<td><input type="text" name="COMPANY_NAME" id="COMPANY_NAME" value="${pd.COMPANY_NAME}" maxlength="255" readonly placeholder="这里输入客户姓名" title="客户姓名" class="width-75"/></td>
										</tr>
										<tr>
											<td class="align-right width-25">证件号类型:<span class="red ">*</span></td>
											<td>
												<select class="width-75" dict-name="CRED_TYPE_COM" disabled default-value="${pd.CREDENTIALS_NO_TYPE}" name="CREDENTIALS_NO_TYPE" id="CREDENTIALS_NO_TYPE">   
												</select>
										...
										<tr>
											...
											<td>
												<select class="width-75" dict-name="EntFindReason" disabled default-value="${pd.QUERY_REASON}" name="QUERY_REASON" id="FIND_REASON">
												</select>
											</td>
										</tr>
										<tr>
										...
										<c:if test="${appInfo.business_licence != '0' }">
											<tr>
												<td class="align-right width-30 paddingt-13">营业执照:</td>
												<td>
													<a href="<%=basePath%>uploadFiles/uploadImgs/${appInfo.business_licence}" target="_blank"><img src="<%=basePath%>uploadFiles/uploadImgs/${appInfo.business_licence}" width="210"/></a>
												</td>
											</tr>
										</c:if>
										<tr>
