					...
					<form action="CreditInquiry/${msg}.do?INTERNAL=1" name="Form" id="Form" method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped "><!-- table-bordered table-hover -->
							...
							<tr>
								...
								<td><input type="text" name="ORG_CODE" id="ORG_CODE" value="亿联银行"  maxlength="32" readonly placeholder="这里输入申请机构"  class="width-75"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control width-75" disabled dict-name="CRED_TYPE_PER" default-value="${pd.CREDENTIALS_TYPE}" name="CREDENTIALS_TYPE" id="CREDENTIALS_TYPE">
									</select>
