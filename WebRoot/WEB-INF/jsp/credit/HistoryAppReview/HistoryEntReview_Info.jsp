								...
								<form action="" name="Form" id="Form" method="post">
									...
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										...
										<tr>
											...
											<td>
											    <select style="width:260px" disabled dict-name="CRED_TYPE_COM" default-value="${pd.CREDENTIALS_NO_TYPE}" name="CREDENTIALS_NO_TYPE" id="CREDENTIALS_NO_TYPE" class="width-75">  
												</select>
											</td>
										</tr>
										<tr>
											<td class="align-right">企业证件号码:</td>
											<td><input type="text" name="CHINA_CREDIT_CODE" id="CHINA_CREDIT_CODE" readonly value="${appInfo.CHINA_CREDIT_CODE}"  maxlength="32" class="width-75"/></td>
										</tr>
										<tr>
