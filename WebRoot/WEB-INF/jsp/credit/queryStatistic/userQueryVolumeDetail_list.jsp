			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="UserQueryVolume/goDetail.do?APPLICATION_TIME=${pd.APPLICATION_TIME}&ORG_ID=${pd.ORG_ID}&USER_ID=${pd.USER_ID}" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover">	
							<thead>
								<tr>
									...
									<th class="center">申请用户名称</th>
									<th class="center">授权时间</th>
									<th class="center">授权审批人</th>
