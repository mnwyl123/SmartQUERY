		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="BankQueryFlow/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
	...
	<script type="text/javascript">
			...
			$("#Form").ajaxForm({
				success:function(data){
					if(data.msg=="success"){
						...
						bootbox.dialog({
							message: "<span class='bigger-110'>数据导入失败，请重试！</span>",
							buttons: 			
							{ 
								"button":
									{ 
		...
		function fileType(obj){
		    ...
		    if(fileType != '.mdb'){
		    	...
		    	$("#excel").val('');
		    	document.getElementById("excel").files[0] = '请选择.mdb格式的文件';
		    }
		}
	</script>
