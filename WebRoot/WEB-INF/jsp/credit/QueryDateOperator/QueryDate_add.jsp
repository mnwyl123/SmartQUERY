								...
								<form action="QuerydDate/save.do" name="Form" id="Form" method="post">
									...
									<table id="table_report" class="table table-striped"> <!-- table-bordered table-hover  -->
										<tr>
											...
											<td>
												<select class="width-75" dict-name="clientType" default-value="${pd.PARA_TYPE}" name="PARA_TYPE" id="PARA_TYPE" onchange="hasU()">
										...
										<%-- <tr>
											...
											<td>
												...
												<c:if test="${admin != '1'}">
													...
													<input type="text" value="${pd.NAME}"  maxlength="20" class="width-75" readOnly="true"/>
												</c:if>
											</td>
										</tr> --%>
										<tr>
...
dict.init({ids:['PARA_TYPE']});
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>QuerydDate/hasId.do',
