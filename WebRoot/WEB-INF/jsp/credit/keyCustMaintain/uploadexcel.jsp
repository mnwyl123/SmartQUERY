		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="KeyCustMaintain/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								...
								<!-- -->
								    <a onclick="window.location.href='<%=basePath%>/KeyCustMaintain/downExcel.do'" onmouseover="pic1(this);" onmouseout="pic2(this);"><i id ="changePic" class="iconfont icon-moban bigger-190 green1" style="width:35px;height:35px;"></i><span style="font-size:12px;position: relative;top:20px;left:-40px;color: #595959;">数据模板</span> </a>
								</div>
