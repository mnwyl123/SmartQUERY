								...
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped" >
										...
										<%-- <tr>
											...
											<td><input type="hidden" name="IP" id="IP"  value="${pd.IP }" maxlength="32" placeholder="IP" title="IP" class="width-80"/></td>
										</tr>
										<tr>
											<td class="align-right">MAC:</td>
											<td><input type="hidden" name="MAC" id="MAC"  value="${pd.MAC}" maxlength="32" placeholder="MAC" title="MAC" class="width-80"/></td>
										</tr>  --%>
									</table>
									</div>
									<div class="footfix">
