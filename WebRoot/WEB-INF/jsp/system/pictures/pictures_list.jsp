						...
						<tr>
							<td class="align-left width-50 searchM">
							  <c:if test="${QX.query == 1 }">
								...
								<span class="input-icon">
									<input autocomplete="off" class="nav-search-input"  id="nav-search-input" type="text" name="keyword"  value="${pd.keyword}" placeholder="搜&nbsp;索..." />
							...
							<td class="align-right width-50">
								...
								<c:if test="${QX.batchDelete == 1 }">
								  <div class="btn-group" >
									<a title="批量删除" class="btn btn-orange btn-mini"
