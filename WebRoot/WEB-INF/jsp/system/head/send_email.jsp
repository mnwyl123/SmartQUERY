			            ...
			            <div class="commitbox_cen">
			              ...
			              <!--   <span class="save" onClick="saveEmail()">保存</span>&nbsp;&nbsp;
			                <span class="quxiao" onClick="cancel_pl()">取消</span> -->
			                 <a class="save btn btn-orange btn-size1" onclick="saveEmail()">确&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;定</a>
		...
		<table style="width:98%;margin-top: 10px;margin-left: 9px;" >
			<tr>
				<td style="margin-top:0px;">
					 ...
					 <div style="float: right;margin-right: 12px;" style="width:19%"><a class='btn btn-blue btn-xs' title="编辑邮箱" onclick="dialog_open();"><i class='ace-icon fa fa-pencil-square-o bigger-120'></i></a></div>
				</td>
			</tr>
			<tr>
				<td>
					 <input type="text" name="TITLE" id="TITLE" value="" placeholder="请输入邮件标题" style="width:96%"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: center;padding-top: 15px;" id="nr">
				 	<a class="save btn btn-orange btn-size1" onclick="sendEm()">发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;送</a>
					<a class="quxiao btn btn-size1 btn-default" onclick="top.Dialog.close();">取&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;消</a> 
