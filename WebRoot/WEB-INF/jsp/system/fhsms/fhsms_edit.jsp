...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
			  	...
			  	<div class="commitbox_inner">
			        <div class="commitbox_top">
			            ...
			            <div class="commitbox_cen">
			                ...
			                <div class="right">
			                <!-- <span class="save" onClick="cancel_pl()">确定</span>&nbsp;&nbsp;
			                <span class="quxiao" onClick="cancel_pl()">取消</span> -->
			                <a class="save btn btn-orange btn-size1" onclick="cancel_pl()">确&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;定</a>
		...
		<div style="padding: 5px 0;float:right;">
			<div class="btn-group">
				<a class="btn btn-orange btn-hanzi" id="send" onclick="sendFhsms();">发&nbsp;&nbsp;&nbsp;送</a>
			</div>
			<div class="btn-group">
				<a class="btn btn-hanzi btn-default" style="border-radius:4px;" onclick="window.location.href=document.referrer;">取&nbsp;&nbsp;&nbsp;消</a> 
			</div>
		</div>
					
		<textarea name="CONTENT" id="CONTENT" style="display:none" ></textarea>
		<input type="hidden" name="TYPE" id="TYPE" value="${pd.TYPE}"/>
		<table style="width:98%;margin-top: 10px;margin-left: 9px;height:431px;" >
			<tr>
				<td style="margin-top:5px;">
					 <div style="float: left;width:60px;">收信人:</div>
					 <div contenteditable="true" style="overflow:hidden;float: left;width:90%;height:21px;font-size:13px; border:1px solid #cccccc; word-wrap: break-word;" title="多用户间用;隔开" id="USERNAME" onfocus="changeDiv();" onblur="hasU()">${pd.USERNAME}</div>
					 <%-- <div style="float: left;" style="width:81%"><textarea name="USERNAME" id="USERNAME" rows="1" cols="50" style="width:595px;min-height:32px;" title="这里查看全部收信人">${pd.USERNAME}</textarea></div> --%>
					 <div style="float: right;width:3%;" id="sendbox">全部</div><!-- <a class='btn btn-blue btn-xs ' title="查看用户名" style="border-radius: 4px;"><i class="ace-icon fa fa-search nav-search-icon"></i></a> -->
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: center;padding: 15px 0;" id="nr">
	...
	<script type="text/javascript" src="plugins/ueditor/html5media.min.js"></script>
	<!-- 编辑框-->
	<!--引入属于此页面的js -->
