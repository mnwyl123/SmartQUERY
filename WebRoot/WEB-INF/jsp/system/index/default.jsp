...
<body>
  		<table width="100%" style="border-collapse:collapse" >
			  ...
			  <tr id='top' style="height:100px;">
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">本月查询总笔数</div>
			    ...
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">本月查询成功笔数</div>
			    ...
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">本月查询失败笔数</div>
		...
		<table width="100%" style="border-collapse:collapse" >
			  <tr>
			  	<td colspan="4">
			  		<div style="color:#4eabf1;width: 100%;">
			  			<div class="iconfont icon-gongzuo" style="margin:0px 20px;border-bottom: 1px solid #b8b8b8;">异常查询预警</div>
			  		</div>
			  	</td>
			  </tr>
			  <tr id='top' style="height:100px;">
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">查询激增预警</div>
			    	<div style="float:left">
			    		<div style="height: 56px;line-height: 56px;font-size: 20px;color: #f8ab77; margin-left:10px;">${pd.surgeInEarlysum} 条记录</div>
			    	</div>
			    </td>
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">失败占比过大预警</div>
		    		<div style="float:left">
		    			<div style="height: 56px;line-height: 56px;font-size: 20px;color: #e46b6c; margin-left: 10px;">${pd.failPercent} 条记录</div>
		    		</div>
			    </td>
			    <td width="25%" class="chart" style="padding-left:3%">
					<div style="font-size: 20px;">短期相同客户查询预警</div>
			    	<div style="float:left">
				    	<div style="height: 56px;line-height: 56px;font-size: 20px;color: #8fc8f5; margin-left: 10px;">${pd.shorttime} 条记录</div>
			   		</div>	
			    </td>
			  </tr>
		</table>
		    ...
		    series : [
		        {
		            ...
		            center: ['50%', '50%'],
		            data:[
		                {value:${pd.PmSucess}, name:'查询成功'},
		                {value:${pd.PmFail}, name:'查询失败'},
		                {value:${pd.PmCheck}, name:'待审核'},
		                {value:${pd.PmSubmit}, name:'待提交'},
		            ],
		            itemStyle: {
		                emphasis: {
		                    shadowBlur: 10,
		    ...
		    series : [
		        {
		            ...
		            center: ['50%', '50%'],
		            data:[
		                {value:${pd.CmSucess}, name:'查询成功'},
		                {value:${pd.CmFail}, name:'查询失败'},
		                {value:${pd.CmCheck}, name:'待审核'},
		                {value:${pd.CmSubmit}, name:'待提交'},
		            ],
		            itemStyle: {
		                emphasis: {
		                    shadowBlur: 10,
