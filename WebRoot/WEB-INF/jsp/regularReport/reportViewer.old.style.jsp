...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>css/base/regularReportGrid.css">
<link rel="stylesheet" type="text/css"
...
<script type="text/javascript"
	src="<%=basePath%>js/jquery-ui-1.8.custom.js"></script>
...
function drawTopLeftCell() {
	...
	$(".topLeft2bottomRightLine").each(function(){
		painter.drawLine($(this).offset().left,$(this).offset().top - $("#northPan").height()-6,
			...
			$(this).offset().top + $(this).outerHeight() - $("#northPan").height()-6);
		/*
...
<body id="regularReport" >
	...
	<div id="centerPan" class="ui-layout-center"
		style="position: relative; padding: 1em 2px 0 2px; margin: 0; text-align: center; overflow: auto;">
		${reportHtml }</div>

	<div id="northPan" class="ui-layout-north"
		style="padding: 0; margin: 0;">${inputPan } ${buttons }</div>
	
	
	<div id="southPan" class="ui-layout-south"
		style="height: 1.2em; padding: 0; margin: 0; background-color: silver;">
